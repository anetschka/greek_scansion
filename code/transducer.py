...
class vowelTransducer(object):
    ...
    def __init__(self):
        ...
        self.vowelTransducer.add_transition(0, 1, '?', '-', 1)
        #second half of first foot
        self.vowelTransducer.add_transition(1, 2, '-', '-', 0.6)
        self.vowelTransducer.add_transition(1, 2, '?', '-', 0.6)
        self.vowelTransducer.add_transition(1, 11, '?', '*', 0.2)
        self.vowelTransducer.add_transition(11, 2, '?', '*', 0.2)
        #first half of second foot
        self.vowelTransducer.add_transition(2, 3, '-', '-', 1)
        self.vowelTransducer.add_transition(2, 3, '?', '-', 1)
        #second half of second foot
        self.vowelTransducer.add_transition(3, 4, '-', '-', 0.5)
        self.vowelTransducer.add_transition(3, 4, '?', '-', 0.5)
        self.vowelTransducer.add_transition(3, 33, '?', '*', 0.25)
        self.vowelTransducer.add_transition(33, 4, '?', '*', 0.25)
        #first half of third foot
        self.vowelTransducer.add_transition(4, 5, '-', '-', 1)
        self.vowelTransducer.add_transition(4, 5, '?', '-', 1)
        #second half of third foot
        self.vowelTransducer.add_transition(5, 6, '-', '-', 0.8)
        self.vowelTransducer.add_transition(5, 6, '?', '-', 0.8)
        self.vowelTransducer.add_transition(5, 55, '?', '*', 0.1)
        self.vowelTransducer.add_transition(55, 6, '?', '*', 0.1)
        ...
        self.vowelTransducer.add_transition(8, 9, '?', '-', 1)
        #second half of fifth foot
        self.vowelTransducer.add_transition(9, 10, '-', '-', 0.9)
        self.vowelTransducer.add_transition(9, 10, '?', '-', 0.9)
        self.vowelTransducer.add_transition(9, 99, '?', '*', 0.05)
        self.vowelTransducer.add_transition(99, 10, '?', '*', 0.05)
        ...
        #TODO: add logics for merging syllables after linguistic consultation
        #(if not handled already in correction function)
